...
- [x] **Step 1: 编写生成 Codex App-Server TypeScript 绑定和 JSON Schema 的脚本**
...
- [x] **Step 3: 编写 Node.js 探针脚本 `probes/codex/test-app-server.mjs`**
...
- [x] **Step 1: 编写 Claude Code 流式会话探针 `probes/claude/test-claude-session.mjs`**
...
- [x] **Step 3: 撰写 `docs/probes/claude.md`**
...
- [x] **Step 1: 汇总三端探针实测数据，锁定各端能力等级（L1/L2/L3）**
- [x] **Step 2: 做出最终架构决断（确定控制器基座是扩展既有工具还是轻量自研核心）**
- [x] **Step 3: 输出 `docs/decisions/architecture.md` 并更新总体开发进度**
